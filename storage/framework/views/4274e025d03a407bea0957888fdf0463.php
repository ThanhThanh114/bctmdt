...
<body>
    ...
    <header class="header-home-page">
        ...
        <div class="header-nav-desktop">
            <ul>
                <li><a href="<?php echo e(route('home')); ?>" class="<?php echo e($current_page == 'home' ? 'active' : ''); ?>">Trang chủ</a>
                </li>
                <li><a href="<?php echo e(route('trips.trips')); ?>" class="<?php echo e($current_page == 'trips' ? 'active' : ''); ?>">Lịch
                        trình</a></li>
                <li><a href="<?php echo e(route('tracking.tracking')); ?>"
                        class="<?php echo e($current_page == 'tracking' ? 'active' : ''); ?>">Tra cứu vé</a></li>
                <li><a href="<?php echo e(route('news.news')); ?>" class="<?php echo e($current_page == 'news' ? 'active' : ''); ?>">Tin tức</a>
                </li>
                <li><a href="<?php echo e(route('invoice.index')); ?>" class="<?php echo e($current_page == 'invoice' ? 'active' : ''); ?>">Hóa
                        đơn</a></li>
                <li><a href="<?php echo e(route('contact.contact')); ?>"
                        class="<?php echo e($current_page == 'contact' ? 'active' : ''); ?>">Liên hệ</a></li>
                <li><a href="<?php echo e(route('about.about')); ?>" class="<?php echo e($current_page == 'about' ? 'active' : ''); ?>">Về chúng
                        tôi</a></li>
            </ul>
        </div>
    ...
    <div id="mobile-user-menu" class="mobile-user-menu" style="display: none;">
        <div class="mobile-user-info">
            ...
            <span><?php echo e(Auth::user()->fullname ?? Auth::user()->name ?? 'User'); ?></span>
        </div>
                        ...
                        <div class="location-field">
                            ...
                            <div class="location-input">
                                <select name="start" required>
                                    ...
                                    <option value="<?php echo e($city->ten_tram); ?>"
                                        <?php echo e(request('start') == $city->ten_tram ? 'selected' : ''); ?>>
                        ...
                        <div class="location-field">
                            ...
                            <div class="location-input">
                                <select name="end" required>
                                    ...
                                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($city->ten_tram); ?>"
                                        <?php echo e(request('end') == $city->ten_tram ? 'selected' : ''); ?>>
                                        <?php echo e($city->ten_tram); ?>
                    ...
                    <div class="date-ticket-wrapper">
                        <div class="date-field">
                            ...
                            <div class="date-input">
                                <input type="date" name="date" value="<?php echo e(request('date', date('Y-m-d'))); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="ticket-field">
                            ...
                            <div class="ticket-input">
                                <select name="ticket">
                                    <option value="1" <?php echo e(request('ticket', 1) == 1 ? 'selected' : ''); ?>>1</option>
                                    <option value="2" <?php echo e(request('ticket') == 2 ? 'selected' : ''); ?>>2</option>
                                    <option value="3" <?php echo e(request('ticket') == 3 ? 'selected' : ''); ?>>3</option>
                                    <option value="4" <?php echo e(request('ticket') == 4 ? 'selected' : ''); ?>>4</option>
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    </script><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/layouts/header-search.blade.php ENDPATH**/ ?>