...
<header class="header-home-page">
            ...
            <?php if(auth()->guard()->check()): ?>
                <div class="user-dropdown">
                    <button class="user-btn" type="button">
                        ...
                        <?php echo e(Auth::user()->fullname ?? Auth::user()->name ?? 'User'); ?>

                        <i class="fas fa-chevron-down" style="color: #333; font-size: 12px;"></i>
                    </button>
                    <div class="user-menu" id="user-menu">
                        <?php if(Auth::user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="user-menu-item">
                                <i class="fas fa-cog"></i> Trang quản trị
                            </a>
                            <hr style="margin: 8px 0; border: none; border-top: 1px solid #e5e7eb;">
                        <?php elseif(Auth::user()->role === 'staff'): ?>
                            <a href="<?php echo e(route('staff.dashboard')); ?>" class="user-menu-item">
                                <i class="fas fa-user-tie"></i> Trang nhân viên
                            </a>
                            <hr style="margin: 8px 0; border: none; border-top: 1px solid #e5e7eb;">
                        <?php elseif(Auth::user()->role === 'bus_owner'): ?>
                            <a href="<?php echo e(route('bus-owner.dashboard')); ?>" class="user-menu-item">
                                <i class="fas fa-bus"></i> Trang nhà xe
                            </a>
                            <hr style="margin: 8px 0; border: none; border-top: 1px solid #e5e7eb;">
                        <?php endif; ?>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="user-menu-item">
                            <i class="fas fa-user-edit"></i> Thông tin tài khoản
                        </a>
                        <a href="<?php echo e(route('booking.history')); ?>" class="user-menu-item">
    ...
    <div class="header-nav-desktop">
        <a href="<?php echo e(route('home')); ?>" class="nav-link <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">Trang
            chủ</a>
        <a href="<?php echo e(route('trips.trips')); ?>" class="nav-link <?php echo e(request()->routeIs('trips.*') ? 'active' : ''); ?>">Lịch
            trình</a>
        <a href="<?php echo e(route('tracking.tracking')); ?>"
            class="nav-link <?php echo e(request()->routeIs('tracking.*') ? 'active' : ''); ?>">Tra cứu vé</a>
        <a href="<?php echo e(route('news.news')); ?>" class="nav-link <?php echo e(request()->routeIs('news.*') ? 'active' : ''); ?>">Tin
            tức</a>
        <a href="<?php echo e(route('invoice.index')); ?>"
            class="nav-link <?php echo e(request()->routeIs('invoice.*') ? 'active' : ''); ?>">Hóa đơn</a>
        <a href="<?php echo e(route('contact.contact')); ?>"
            class="nav-link <?php echo e(request()->routeIs('contact.*') ? 'active' : ''); ?>">Liên hệ</a>
        <a href="<?php echo e(route('about.about')); ?>" class="nav-link <?php echo e(request()->routeIs('about.*') ? 'active' : ''); ?>">Về
            chúng tôi</a>
    </div> <!-- Mobile header -->
        ...
        <div class="mobile-menu-overlay">
            <div class="mobile-menu-content">
                <div class="mobile-menu-header">
                    <a href="<?php echo e(url('/')); ?>" class="mobile-menu-logo"></a>
                </div>

                <?php if(auth()->guard()->check()): ?>
                    <div class="mobile-user-menu">
                        <div class="mobile-user-info">
                            <h4>Xin chào, <?php echo e(Auth::user()->fullname ?? Auth::user()->name ?? 'User'); ?>!</h4>
                        </div>
                        <ul class="mobile-user-links">
                            <li><a href="<?php echo e(route('profile.edit')); ?>"><i class="fas fa-user-edit"></i> Thông tin tài
                                    khoản</a></li>
                            <li><a href="<?php echo e(route('booking.history')); ?>"><i class="fas fa-history"></i> Lịch sử đặt
                                    vé</a></li>
                        </ul>
                ...
                <?php else: ?>
                    <div class="mobile-login">
                        <a href="<?php echo e(route('login')); ?>"><button>Đăng nhập/Đăng ký</button></a>
                    </div>
                <?php endif; ?>

                <nav class="mobile-nav">
                    <ul>
                        <li><a href="<?php echo e(route('home')); ?>" class="<?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">Trang
                                chủ</a></li>
                        <li><a href="<?php echo e(route('trips.trips')); ?>"
                                class="<?php echo e(request()->routeIs('trips.*') ? 'active' : ''); ?>">Lịch trình</a></li>
                        <li><a href="<?php echo e(route('tracking.tracking')); ?>"
                                class="<?php echo e(request()->routeIs('tracking.*') ? 'active' : ''); ?>">Tra cứu vé</a></li>
                        <li><a href="<?php echo e(route('news.news')); ?>"
                                class="<?php echo e(request()->routeIs('news.*') ? 'active' : ''); ?>">Tin tức</a></li>
                        <li><a href="<?php echo e(route('invoice.index')); ?>"
                                class="<?php echo e(request()->routeIs('invoice.*') ? 'active' : ''); ?>">Hóa đơn</a></li>
                        <li><a href="<?php echo e(route('contact.contact')); ?>"
                                class="<?php echo e(request()->routeIs('contact.*') ? 'active' : ''); ?>">Liên hệ</a></li>
                        <li><a href="<?php echo e(route('about.about')); ?>"
                                class="<?php echo e(request()->routeIs('about.*') ? 'active' : ''); ?>">Về chúng tôi</a></li>
                    </ul>
                </nav>
            </div>
        </div>
...
</script><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/layouts/header.blade.php ENDPATH**/ ?>