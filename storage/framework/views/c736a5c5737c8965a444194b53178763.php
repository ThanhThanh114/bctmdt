...
<?php $__env->startSection('title', 'Chỉnh sửa nhân viên'); ?>

<?php $__env->startSection('page-title', 'Chỉnh sửa nhân viên'); ?>
...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card card-warning">
            ...
            <form action="<?php echo e(route('bus-owner.nhan-vien.update', $nhanVien->ma_nv)); ?>" method="POST" id="editForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="#<?php echo e($nhanVien->ma_nv); ?>" disabled>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('ten_nv', $nhanVien->ten_nv)); ?>"
                            required
                            autofocus>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <option value="Tài xế" <?php echo e(old('chuc_vu', $nhanVien->chuc_vu) == 'Tài xế' ? 'selected' : ''); ?>>Tài xế</option>
                            <option value="Phụ xe" <?php echo e(old('chuc_vu', $nhanVien->chuc_vu) == 'Phụ xe' ? 'selected' : ''); ?>>Phụ xe</option>
                            <option value="Quản lý" <?php echo e(old('chuc_vu', $nhanVien->chuc_vu) == 'Quản lý' ? 'selected' : ''); ?>>Quản lý</option>
                            <option value="Nhân viên kỹ thuật" <?php echo e(old('chuc_vu', $nhanVien->chuc_vu) == 'Nhân viên kỹ thuật' ? 'selected' : ''); ?>>Nhân viên kỹ thuật</option>
                            <option value="Nhân viên bán vé" <?php echo e(old('chuc_vu', $nhanVien->chuc_vu) == 'Nhân viên bán vé' ? 'selected' : ''); ?>>Nhân viên bán vé</option>
                            <option value="Khác" <?php echo e(old('chuc_vu', $nhanVien->chuc_vu) == 'Khác' ? 'selected' : ''); ?>>Khác</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('so_dien_thoai', $nhanVien->so_dien_thoai)); ?>"
                            required
                            pattern="[0-9]{10,11}"
                            maxlength="11">
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('email', $nhanVien->email)); ?>"
                            required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Lưu ý:</strong> Nhân viên thuộc nhà xe <strong><?php echo e($nhaXe->name); ?></strong>
                    </div>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?php echo e(route('bus-owner.nhan-vien.index')); ?>" class="btn btn-default">
...
<script>
    $(document).ready(function() {
        ...
        const originalValues = {
            ten_nv: '<?php echo e($nhanVien->ten_nv); ?>',
            chuc_vu: '<?php echo e($nhanVien->chuc_vu); ?>',
            so_dien_thoai: '<?php echo e($nhanVien->so_dien_thoai); ?>',
            email: '<?php echo e($nhanVien->email); ?>'
        };
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\bctmdt\resources\views/AdminLTE/bus_owner/nhan_vien/edit.blade.php ENDPATH**/ ?>