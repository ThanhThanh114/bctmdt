...
<div id="monthlyBookingsData" data-json="<?php echo e(json_encode($monthly_bookings ?? [])); ?>" style="display:none;"></div>
<div id="dailyRevenue7Data" data-json="<?php echo e(json_encode($daily_revenue_7 ?? [])); ?>" style="display:none;"></div>
<div id="dailyRevenue30Data" data-json="<?php echo e(json_encode($daily_revenue_30 ?? [])); ?>" style="display:none;"></div>
<div id="monthlyRevenue12Data" data-json="<?php echo e(json_encode($monthly_revenue_12 ?? [])); ?>" style="display:none;"></div>
<div id="yearlyRevenueData" data-json="<?php echo e(json_encode($yearly_revenue ?? [])); ?>" style="display:none;"></div>
<div id="topRoutesData" data-json="<?php echo e(json_encode($top_routes ?? [])); ?>" style="display:none;"></div>
<div id="topCustomersData" data-json="<?php echo e(json_encode($top_customers ?? [])); ?>" style="display:none;"></div>
...
<div class="alert alert-info">
    ...
    <ul class="mb-0">
        <li>Bookings 7 days: <?php echo e(count($daily_revenue_7 ?? [])); ?> days, Total:
            <?php echo e(number_format(array_sum($daily_revenue_7 ?? []))); ?> VNĐ
        </li>
        <li>Bookings 30 days: <?php echo e(count($daily_revenue_30 ?? [])); ?> days, Total:
            <?php echo e(number_format(array_sum($daily_revenue_30 ?? []))); ?> VNĐ
        </li>
        <li>Monthly 12: <?php echo e(count($monthly_revenue_12 ?? [])); ?> months, Total:
            <?php echo e(number_format(array_sum($monthly_revenue_12 ?? []))); ?> VNĐ
        </li>
        <li>Yearly: <?php echo e(count($yearly_revenue ?? [])); ?> years, Total:
            <?php echo e(number_format(array_sum($yearly_revenue ?? []))); ?> VNĐ
        </li>
    </ul>
</div>
<?php endif; ?>
        ...
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e(number_format($stats['total_users'] ?? 0)); ?></h2>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e(number_format($stats['total_employees'] ?? 0)); ?></h2>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.nhanvien.index')); ?>" class="text-white text-decoration-none">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e(number_format($stats['total_bookings'] ?? 0)); ?></h2>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.datve.index')); ?>" class="text-white text-decoration-none">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e(number_format($stats['total_comments'] ?? 0)); ?></h2>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.binhluan.index')); ?>" class="text-white text-decoration-none">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold text-dark"><?php echo e(number_format($stats['total_promotions'] ?? 0)); ?>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.khuyenmai.index')); ?>" class="text-dark text-decoration-none font-weight-bold">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e(number_format($stats['total_news'] ?? 0)); ?></h2>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.tintuc.index')); ?>" class="text-white text-decoration-none">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e(number_format($stats['total_trips'] ?? 0)); ?></h2>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e(number_format($stats['total_bus_companies'] ?? 0)); ?></h2>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold text-dark"><?php echo e(\App\Models\TramXe::count()); ?></h2>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        ->count();
                        ?>
                        <h2 class="mb-0 font-weight-bold text-dark"><?php echo e($totalRoutes); ?></h2>
...
<div class="row mt-3">
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold text-dark"><?php echo e(number_format($stats['total_contacts'] ?? 0)); ?>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.contact.index')); ?>" class="text-dark text-decoration-none font-weight-bold">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.report.index')); ?>" class="text-dark text-decoration-none font-weight-bold">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0 font-weight-bold"><?php echo e($stats['active_promotions'] ?? 0); ?></h2>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.khuyenmai.index')); ?>" class="text-white text-decoration-none">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-lg"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        ->count();
                        ?>
                        <h2 class="mb-0 font-weight-bold text-dark"><?php echo e($newUsersThisMonth); ?></h2>
            ...
            <div class="card-footer bg-transparent border-0 text-right">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="text-dark text-decoration-none font-weight-bold">
                    Xem chi tiết <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
            ...
            <div class="card-body" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="d-flex align-items-center text-white">
                    ...
                    <div class="flex-grow-1">
                        ...
                        ?>
                        <h2 class="mb-0"><?php echo e(number_format($todayRev)); ?> đ</h2>
            ...
            <div class="card-body" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                <div class="d-flex align-items-center text-white">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <h2 class="mb-0"><?php echo e(number_format($stats['monthly_revenue'] ?? 0)); ?> đ</h2>
                        <div class="progress mt-2" style="height:8px; background: rgba(255,255,255,0.3);">
                            <div class="progress-bar bg-light" role="progressbar" style="width: 85%;"></div>
                        </div>
                        <small>Tháng <?php echo e(date('m/Y')); ?></small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-0">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $bus_company_stats ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($idx + 1); ?></td>
                            <td><strong><?php echo e($company->ten_nha_xe ?? 'N/A'); ?></strong></td>
                            <td><?php echo e($company->so_dien_thoai ?? 'N/A'); ?></td>
                            <td class="text-right"><span
                                    class="badge badge-primary"><?php echo e($company->chuyen_xe_count ?? 0); ?></span></td>
                        </tr>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-0">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        <?php $routeIdx = 0; ?>
                        <?php $__empty_1 = true; $__currentLoopData = ($top_routes ?? collect())->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $routeIdx++; ?>
                        <tr>
                            <td><?php echo e($routeIdx); ?></td>
                            <td><strong><?php echo e($route); ?></strong></td>
                            <td class="text-right"><span class="badge badge-success"><?php echo e($count); ?></span></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-0" style="max-height: 350px; overflow-y: auto;">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = ($recent_users ?? [])->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($u->id); ?></td>
                            <td><?php echo e($u->fullname ?? ($u->username ?? 'N/A')); ?></td>
                            <td><?php echo e($u->email ?? 'N/A'); ?></td>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-0" style="max-height: 350px; overflow-y: auto;">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = ($top_customers ?? [])->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $usr = $tc['user'] ?? null; ?>
                        <tr>
                            <td><span class="badge badge-pill"
                                    style="background: linear-gradient(135deg, #667eea, #764ba2); color: #fff;"><?php echo e($loop->iteration); ?></span>
                            </td>
                            <td><?php echo e(optional($usr)->fullname ?? optional($usr)->username ?? 'N/A'); ?></td>
                            <td><?php echo e(optional($usr)->email ?? 'Chưa cập nhật'); ?></td>
                            <td><?php echo e(optional($usr)->phone ?? 'Chưa cập nhật'); ?></td>
                            <td class="text-right"><span class="badge badge-success"><i
                                        class="fas fa-ticket-alt mr-1"></i><?php echo e($tc['tickets'] ?? 0); ?></span></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
            ...
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button class="btn btn-sm btn-light"><i class="fas fa-search-location mr-1"></i>Tổng:
                        <?php echo e($stats['total_bus_companies'] ?? 15); ?> nhà xe</button>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-0">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = ($recent_trips ?? [])->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo e(optional($trip->nhaXe)->ten_nha_xe ?? 'N/A'); ?></td>
                            <td><?php echo e($from); ?> <i class="fas fa-arrow-right mx-1"></i> <?php echo e($to); ?></td>
                            ...
                            <td><strong><?php echo e(number_format($trip->gia_ve ?? 0)); ?> đ</strong></td>
                            <td><span
                                    class="badge badge-success"><?php echo e(($trip->so_cho ?? 0) - ($trip->so_ve ?? 0)); ?>/<?php echo e($trip->so_cho ?? 0); ?></span>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
            ...
            <div class="card-body p-0">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo e($booking->ma_ve ?? $booking->id); ?></td>
                            <td>
                                <strong><?php echo e(optional($booking->user)->full_name ?? optional($booking->user)->username ?? 'N/A'); ?></strong><br>
                                <small class="text-muted"><?php echo e(optional($booking->user)->email ?? ''); ?></small>
                            </td>
                            <td>
                                <strong><?php echo e(optional($booking->chuyenXe)->ten_xe ?? 'N/A'); ?></strong><br>
                                <small class="text-muted">
                                    <?php echo e(optional(optional($booking->chuyenXe)->tramDi)->ten_tram ?? 'N/A'); ?>

                                    <i class="fas fa-arrow-right mx-1"></i>
                                    <?php echo e(optional(optional($booking->chuyenXe)->tramDen)->ten_tram ?? 'N/A'); ?>
                            ...
                            <td>
                                ...
                                <span class="badge badge-primary badge-pill"
                                    title="<?php echo e($seatDisplay); ?>"><?php echo e($seatCount); ?></span>
                                <?php else: ?>
                            ...
                            <td>
                                <?php if($total > 0): ?>
                                <strong class="text-success"><?php echo e(number_format($total, 0, ',', '.')); ?> đ</strong>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                <span class="badge badge-danger"><?php echo e($booking->trang_thai ?? 'Đã hủy'); ?></span>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/AdminLTE/admin/dashboard.blade.php ENDPATH**/ ?>