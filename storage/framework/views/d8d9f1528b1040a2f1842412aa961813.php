    ...
    <div class="payment-container">
        ...
        <div class="payment-header">
            ...
            <div class="booking-code">
                <i class="fas fa-ticket-alt"></i> <?php echo e($code); ?>
            ...
            <div class="countdown-timer" id="countdown-container" data-expires="<?php echo e($expiresAt->timestamp); ?>">
                <i class="fas fa-clock"></i>
                <span class="countdown-text">
                    Thời gian còn lại: <strong id="countdown"><?php echo e(gmdate('i:s', $remainingSeconds)); ?></strong>
                </span>
            </div>
        </div>
        ...
        <div class="payment-body">
            ...
            <div class="payment-info">
                ...
                <div class="info-card">
                    <div class="info-row">
                        ...
                        <span class="info-value">
                            <?php echo e($firstBooking->chuyenXe->tramDi->ten_tram); ?> →
                            <?php echo e($firstBooking->chuyenXe->tramDen->ten_tram); ?>
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">
                            <?php echo e(\Carbon\Carbon::parse($firstBooking->chuyenXe->ngay_di)->format('d/m/Y')); ?>
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">
                            <?php echo e(\Carbon\Carbon::parse($firstBooking->chuyenXe->gio_di)->format('H:i')); ?>
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">
                            <?php echo e($bookings->pluck('so_ghe')->join(', ')); ?>
                ...
                <div class="total-amount">
                    ...
                    <div class="amount"><?php echo e(number_format($paymentInfo['total_amount'], 0, ',', '.')); ?>đ</div>
                </div>
                ...
                <div class="bank-info-card">
                    ...
                    <div class="bank-row">
                        ...
                        <span class="bank-value">
                            <?php echo e(number_format($paymentInfo['total_amount'], 0, ',', '.')); ?>đ
                            <button class="copy-btn" onclick="copyText('<?php echo e($paymentInfo['total_amount']); ?>', 'số tiền')">
                                <i class="fas fa-copy"></i>
                            </button>
                        </span>
                    </div>
                    <div class="bank-row">
                        ...
                        <span class="bank-value">
                            ...
                            <button class="copy-btn" onclick="copyText('<?php echo e($code); ?>', 'mã booking')">
                                <i class="fas fa-copy"></i>
                            </button>
                        </span>
                    </div>
            ...
            <div class="qr-section">
                <div class="qr-card">
                    ...
                    <div class="qr-code-wrapper">
                        <img src="https://img.vietqr.io/image/ACB-16826531-compact2.jpg?amount=<?php echo e($paymentInfo['total_amount']); ?>&addInfo=<?php echo e($code); ?>&accountName=LOI LE THANH"
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/payment/show.blade.php ENDPATH**/ ?>