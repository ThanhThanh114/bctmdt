            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('bus-owner.nhan-vien.index')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('bus-owner.nhan-vien.*') ? 'active' : ''); ?>">
                                <i class="nav-icon fas fa-users"></i>
                                <p>Quản lý nhân viên</p>
                            </a>
                        </li>
...
</html><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/layouts/admin.blade.php ENDPATH**/ ?>