                            ...
                            <div class="news-card">
                                    ...
                                    <?php if($news->hinh_anh): ?>
                                        <?php if(filter_var($news->hinh_anh, FILTER_VALIDATE_URL)): ?>
                                            ...
                                            <img src="<?php echo e($news->hinh_anh); ?>" alt="<?php echo e(htmlspecialchars($news->tieu_de)); ?>" loading="lazy"
                                                onerror="this.src='<?php echo e(asset('assets/images/header.jpg')); ?>'">
                                        <?php else: ?>
                                            
                                            <img src="<?php echo e(asset($news->hinh_anh)); ?>" alt="<?php echo e(htmlspecialchars($news->tieu_de)); ?>"
                                                loading="lazy" onerror="this.src='<?php echo e(asset('assets/images/header.jpg')); ?>'">
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('assets/images/header.jpg')); ?>"
                                            alt="<?php echo e(htmlspecialchars($news->tieu_de)); ?>" loading="lazy">
                                    <?php endif; ?>
                                ...
                                <div class="news-content">
                                    <div class="news-date">
                                        ...
                                        <?php echo e(date('d/m/Y', strtotime($news->ngay_dang))); ?>

                                    </div>
                                    <h3 class="news-title"><?php echo e(htmlspecialchars($news->tieu_de)); ?></h3>
                                    <p class="news-excerpt"><?php echo e(Str::limit(strip_tags($news->noi_dung), 120)); ?></p>
                                    <a href="<?php echo e(route('news.show', $news->ma_tin)); ?>" class="news-link">
                                        Đọc thêm
...
<!-- ======================== END 5. FUTA CONNECT ======================== --><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/home/news.blade.php ENDPATH**/ ?>