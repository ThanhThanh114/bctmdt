    ...
    <div class="success-container">
        ...
        <div class="booking-details">
            ...
            <div class="booking-code">
                ...
                <div class="code-number"><?php echo e($code); ?></div>
            </div>
            ...
            <div class="trip-info">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value"><?php echo e(\Carbon\Carbon::parse($trip->ngay_di)->format('d/m/Y')); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Giờ khởi hành:</span>
                    <span class="info-value"><?php echo e(\Carbon\Carbon::parse($trip->gio_di)->format('H:i')); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Nhà xe:</span>
                    <span class="info-value"><?php echo e($trip->nhaXe->ten_nha_xe); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Loại xe:</span>
                    <span class="info-value"><?php echo e($trip->loai_xe); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Số lượng vé:</span>
                    <span class="info-value"><?php echo e($bookings->count()); ?></span>
                </div>
            </div>
            ...
            <div class="seats-section">
                ...
                <div class="seats-grid">
                    <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="seat-item"><?php echo e($booking->so_ghe); ?></div>
            ...
            <div class="price-summary">
                ...
                <div class="total-amount">
                    <?php echo e(number_format($bookings->count() * $trip->gia_ve, 0, ',', '.')); ?>đ
                </div>
            </div>
        </div>
        ...
        <div class="action-buttons">
            ...
            <a href="<?php echo e(url('/datve')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/booking/success.blade.php ENDPATH**/ ?>