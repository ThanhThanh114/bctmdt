...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="header-info">
            ...
            <div class="date-info">
                <?php echo e(\Carbon\Carbon::parse($trip->ngay_di)->locale('vi')->isoFormat('dddd, DD/MM/YYYY')); ?> -
                <?php echo e(date('H:i', strtotime($trip->gio_di))); ?>
                ...
                <div class="bus-layout">
                    ...
                    <div class="floor">
                        ...
                        <div class="seats-grid">
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('A01', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A01">A01</div>
                                <div class="seat-empty"></div>
                                <div class="seat-empty"></div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A02', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A02">A02</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('A03', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A03">A03</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A04', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A04">A04</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A05', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A05">A05</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('A06', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A06">A06</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A07', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A07">A07</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A08', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A08">A08</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('A09', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A09">A09</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A10', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A10">A10</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A11', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A11">A11</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('A12', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A12">A12</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A13', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A13">A13</div>
                                <div class="seat-empty"></div>
                                <div class="seat-empty"></div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('A15', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A15">A15</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A16', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="A16">A16</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('A17', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                    ...
                    <div class="floor">
                        ...
                        <div class="seats-grid">
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('B01', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B01">B01</div>
                                <div class="seat-empty"></div>
                                <div class="seat-empty"></div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B02', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B02">B02</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('B03', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B03">B03</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B04', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B04">B04</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B05', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B05">B05</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('B06', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B06">B06</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B07', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B07">B07</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B08', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B08">B08</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('B09', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B09">B09</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B10', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B10">B10</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B11', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B11">B11</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('B12', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B12">B12</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B13', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B13">B13</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B14', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B14">B14</div>
                            </div>
                            <div class="seat-row">
                                <div class="seat <?php echo e(in_array('B15', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B15">B15</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B16', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
                                    data-seat="B16">B16</div>
                                <div class="seat-empty"></div>
                                <div class="seat <?php echo e(in_array('B17', $bookedSeats) ? 'seat-sold' : 'seat-available'); ?>"
            ...
            <div class="sidebar">
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($trip->tramDi->ten_tram); ?> - <?php echo e($trip->tramDen->ten_tram); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Thời gian xuất bến:</span>
                        <span
                            class="info-value"><?php echo e(date('H:i d/m/Y', strtotime($trip->ngay_di . ' ' . $trip->gio_di))); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Số lượng ghế:</span>
                        <span class="info-value"><?php echo e($bookingInfo['seat_count']); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Điểm trả khách:</span>
                        <span class="info-value"><?php echo e($trip->tramDen->ten_tram); ?></span>
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value" id="unit-price"><?php echo e(number_format($trip->gia_ve, 0, ',', '.')); ?>đ</span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value" id="total-price"><?php echo e(number_format($trip->gia_ve, 0, ',', '.')); ?>đ</span>
                    </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($bookingInfo['passenger_name']); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Số điện thoại:</span>
                        <span class="info-value"><?php echo e($bookingInfo['passenger_phone']); ?></span>
                    </div>
                    <?php if(!empty($bookingInfo['passenger_email'])): ?>
                        <div class="info-row">
                            <span class="info-label">Email:</span>
                            <span class="info-value"><?php echo e($bookingInfo['passenger_email']); ?></span>
                        </div>
                    <?php endif; ?>
                </div>

                <form method="POST" action="<?php echo e(route('booking.complete')); ?>" id="booking-form">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        let selectedSeats = [];
        const maxSeats = <?php echo e($bookingInfo['seat_count']); ?>;
        const unitPrice = <?php echo e($trip->gia_ve); ?>;
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/booking/seat_selection.blade.php ENDPATH**/ ?>