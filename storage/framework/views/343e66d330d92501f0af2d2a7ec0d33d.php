                    ...
                    <form action="<?php echo e(route('bus-owner.nha-xe.index')); ?>" method="GET" class="form-inline">
                        <div class="input-group input-group-lg" style="width: 100%;">
                            <input type="text" name="search" class="form-control"
                                placeholder="Tìm kiếm theo tên, địa chỉ, SĐT, email..." value="<?php echo e(request('search')); ?>">
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <button type="button" class="btn btn-danger"
                                        onclick="confirmDelete(<?php echo e($nhaXe->ma_nha_xe); ?>)" title="Xóa">
                                ...
                                <form id="delete-form-<?php echo e($nhaXe->ma_nha_xe); ?>"
                                    action="<?php echo e(route('bus-owner.nha-xe.destroy', $nhaXe->ma_nha_xe)); ?>" method="POST"
                                    style="display: none;">
                                    <?php echo csrf_field(); ?>
