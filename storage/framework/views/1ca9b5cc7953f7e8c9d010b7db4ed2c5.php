        ...
        <div class="layout">
            ...
            <div class="mb-8">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div class="text-center">
                                    <div class="text-2xl font-bold orange">
                                        <?php echo e(\Carbon\Carbon::parse($trip->gio_di)->format('H:i:s')); ?>

                                    </div>
                                    <div class="text-sm text-gray-600"><?php echo e($trip->tramDi->ten_tram); ?></div>
                                </div>
                                ...
                                <div class="flex-1 mx-4">
                                    ...
                                    <div class="text-center text-xs text-gray-500 mt-1">
                                        <?php echo e(\Carbon\Carbon::parse($trip->ngay_di)->format('d/m/Y')); ?>
                                ...
                                <div class="text-center">
                                    <div class="text-2xl font-bold orange">
                                        <?php echo e(\Carbon\Carbon::parse($trip->gio_den)->format('H:i:s')); ?>

                                    </div>
                                    <div class="text-sm text-gray-600">
                                        <?php echo e($trip->tramDen->ten_tram); ?>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-semibold"><?php echo e($trip->nhaXe->ten_nha_xe); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="font-medium text-gray-700">
                                    <i class="fas fa-bus orange mr-2"></i>Loại xe:
                                </span>
                                <span class="font-semibold"><?php echo e($trip->loai_xe); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="font-medium text-gray-700">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-semibold text-green-600">
                                    <?php echo e($trip->available_seats); ?> chỗ
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <form method="POST" id="bookingForm" action="<?php echo e(route('booking.store')); ?>">
                        <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('assets/js/futa-chat.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.header-search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\thanh\Documents\GitHub\bctmdt\resources\views/booking/booking.blade.php ENDPATH**/ ?>