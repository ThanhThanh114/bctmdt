    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            ...
            <div class="card-tools">
                <a href="{{ route('admin.nha-xe.create') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-8">
                    <form action="{{ route('admin.nha-xe.index') }}" method="GET" class="form-inline">
                ...
                <div class="col-md-4">
                    <form action="{{ route('admin.nha-xe.index') }}" method="GET" class="form-inline float-right">
                    ...
                    <thead class="thead-dark">
                        <tr>
                            <th width="80" class="text-center">
                                <a href="{{ route('admin.nha-xe.index', array_merge(request()->all(), ['sort_by' => 'ma_nha_xe', 'sort_order' => request('sort_order') == 'asc' ? 'desc' : 'asc'])) }}"
                                    class="text-white">
                                    Mã
                            ...
                            <th>
                                <a href="{{ route('admin.nha-xe.index', array_merge(request()->all(), ['sort_by' => 'ten_nha_xe', 'sort_order' => request('sort_order') == 'asc' ? 'desc' : 'asc'])) }}"
                                    class="text-white">
                                    Tên nhà xe
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('admin.nha-xe.show', $nhaXe->ma_nha_xe) }}"
                                ...
                                <form id="delete-form-{{ $nhaXe->ma_nha_xe }}"
                                    action="{{ route('admin.nha-xe.destroy', $nhaXe->ma_nha_xe) }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <a href="{{ route('admin.nha-xe.index') }}" class="btn btn-primary">
                                        <i class="fas fa-redo"></i> Xem tất cả
                                    </a>
                                    @else
                                    <p>Chưa có nhà xe nào trong hệ thống</p>
                                    <a href="{{ route('admin.nha-xe.create') }}" class="btn btn-success">
