            ...
            <div class="card shadow-lg">
                <div class="card-header bg-gradient-warning text-white">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.nha-xe.show', $nhaXe->ma_nha_xe) }}" class="btn btn-sm btn-light">
                            <i class="fas fa-arrow-left"></i> Quay lại
                        </a>
                    </div>
                </div>

                <form action="{{ route('admin.nha-xe.update', $nhaXe->ma_nha_xe) }}" method="POST" id="editForm">
                    @csrf
                    @method('PUT')
