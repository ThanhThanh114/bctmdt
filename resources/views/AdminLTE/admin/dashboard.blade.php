...
<!-- Top metric cards - 9 Module Quản Lý -->
<div class="row">
    <!-- 1. Quản lý User -->
    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="card text-white bg-danger h-100 shadow-sm">
            ...
            <div class="card-footer text-right">
                <a href="{{ route('admin.users.index') }}" class="text-white">Xem chi tiết <i
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="card text-white bg-primary h-100 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ \App\Models\NhanVien::count() }}</h2>
            ...
            <div class="card-footer text-right">
                <a href="{{ route('admin.nhanvien.index') }}" class="text-white">Xem chi tiết <i
                        class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="card text-white bg-success h-100 shadow-sm">
            ...
            <div class="card-footer text-right">
                <a href="{{ route('admin.datve.index') }}" class="text-white">Xem chi tiết <i
                        class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="card text-white bg-info h-100 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ \App\Models\BinhLuan::count() }}</h2>
            ...
            <div class="card-footer text-right">
                <a href="{{ route('admin.binhluan.index') }}" class="text-white">Xem chi tiết <i
                        class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-sm"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ \App\Models\KhuyenMai::count() }}</h2>
                        <p class="mb-0">Tổng khuyến mãi</p>
                    </div>
                    <div class="display-4 opacity-75"><i class="fas fa-tags"></i></div>
                </div>
            </div>
            <div class="card-footer text-right">
                <a href="{{ route('admin.khuyenmai.index') }}" class="text-white">Xem chi tiết <i
                        class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-sm"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ $stats['total_news'] ?? 0 }}</h2>
            ...
            <div class="card-footer text-right">
                <a href="{{ route('admin.tintuc.index') }}" class="text-white">Xem chi tiết <i
                        class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
    </div>
        ...
        <div class="card text-white bg-secondary h-100 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="display-4 opacity-75"><i class="fas fa-envelope"></i></div>
                </div>
            </div>
            <div class="card-footer text-right">
                <a href="{{ route('admin.contact.index') }}" class="text-white">Xem chi tiết <i
                        class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="card text-white h-100 shadow-sm"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0"><i class="fas fa-chart-line"></i></h2>
                        <p class="mb-0">Báo cáo thống kê</p>
                    </div>
                    <div class="display-4 opacity-75"><i class="fas fa-chart-bar"></i></div>
                </div>
            </div>
            <div class="card-footer text-right">
                <a href="{{ route('admin.report.index') }}" class="text-white">Xem chi tiết <i
                        class="fas fa-arrow-right ml-1"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white bg-info h-100 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ number_format($stats['total_trips'] ?? 0) }}</h2>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white bg-dark h-100 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ number_format($stats['total_bus_companies'] ?? 0) }}</h2>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-sm"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ $stats['active_promotions'] ?? 0 }}</h2>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="card text-white h-100 shadow-sm"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-0">{{ $stats['today_bookings'] ?? 0 }}</h2>
                        <p class="mb-0">Vé đặt hôm nay</p>
                    </div>
