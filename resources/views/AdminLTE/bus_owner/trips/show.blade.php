...
@section('page-title', 'Chi tiết Chuyến xe #' . $trip->id)
@section('breadcrumb')
...
<div class="row">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('bus-owner.trips.edit', $trip->id) }}" class="btn btn-sm btn-warning">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <table class="table table-sm table-borderless">
                            ...
                            <tr>
                                ...
                                <td><strong
                                        class="text-info">{{ \Carbon\Carbon::parse($trip->gio_di)->format('H:i') }}</strong>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table table-sm table-borderless">
                            <tr>
                                ...
                                <td>{{ $trip->loai_xe ?? 'Chưa cập nhật' }}</td>
                            </tr>
                            <tr>
                                <th><i class="fas fa-exchange-alt text-muted mr-2"></i>Loại chuyến:</th>
                                <td>
                                    @if($trip->loai_chuyen == 'Một chiều')
                                    <span class="badge badge-info">{{ $trip->loai_chuyen }}</span>
                                    @else
                                    <span class="badge badge-primary">{{ $trip->loai_chuyen }}</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                <th><i class="fas fa-dollar-sign text-muted mr-2"></i>Giá vé:</th>
                                <td><strong class="text-success">{{ number_format($trip->gia_ve) }}đ</strong></td>
                            </tr>
                            <tr>
                                <th><i class="fas fa-chair text-muted mr-2"></i>Số chỗ:</th>
                                <td>{{ $trip->so_cho }} chỗ</td>
                            </tr>
                            <tr>
                ...
                @if($trip->ten_tai_xe || $trip->sdt_tai_xe)
                <hr>
                <h5 class="text-secondary"><i class="fas fa-user-tie mr-2"></i>Thông tin Tài xế</h5>
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Tên tài xế:</strong> {{ $trip->ten_tai_xe ?? 'Chưa cập nhật' }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>Số điện thoại:</strong> {{ $trip->sdt_tai_xe ?? 'Chưa cập nhật' }}</p>
                    </div>
                </div>
                @endif
            </div>
    ...
    <div class="col-md-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <div class="progress" style="height: 30px;">
                        <div class="progress-bar {{ $bookingRate > 80 ? 'bg-success' : ($bookingRate > 50 ? 'bg-info' : 'bg-warning') }}"
                            role="progressbar" style="width: {{ $bookingRate }}%">
                            <strong>{{ number_format($bookingRate, 1) }}%</strong>
                        </div>
                    </div>
                ...
                <div class="info-box bg-light mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $bookedSeats }} ghế</span>
                    </div>
                </div>
                ...
                <div class="info-box bg-light mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $availableSeats }} ghế</span>
                    </div>
                </div>
                ...
                <div class="info-box bg-light">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ number_format($bookedSeats * $trip->gia_ve) }}đ</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-warning card-outline">
            ...
            <div class="card-body">
                <a href="{{ route('bus-owner.trips.edit', $trip->id) }}" class="btn btn-warning btn-block mb-2">
                    <i class="fas fa-edit mr-2"></i>Chỉnh sửa chuyến xe
                </a>
                <a href="{{ route('bus-owner.dat-ve.index') }}" class="btn btn-info btn-block mb-2">
                ...
                <form action="{{ route('bus-owner.trips.destroy', $trip) }}" method="POST" class="mt-3"
        ...
        <div class="card card-secondary card-outline">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning mb-0">
                    ...
                    <small>Khởi hành lúc {{ \Carbon\Carbon::parse($trip->gio_di)->format('H:i') }}</small>
                </div>
                @elseif($isTomorrow)
                ...
                <div class="alert alert-success mb-0">
                    ...
                    <small>{{ $tripDateTime->diffForHumans() }}</small>
                </div>
                @endif
            </div>
        </div>
