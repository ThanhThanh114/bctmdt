                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="loai_xe" class="form-control">
                                ...
                                <option value="Giường nằm" {{ request('loai_xe') == 'Giường nằm' ? 'selected' : '' }}>
                                    Giường nằm</option>
                                <option value="Ghế ngồi" {{ request('loai_xe') == 'Ghế ngồi' ? 'selected' : '' }}>Ghế
                                    ngồi</option>
                                <option value="Limousine" {{ request('loai_xe') == 'Limousine' ? 'selected' : '' }}>
                                    Limousine</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            ...
                            <select name="loai_chuyen" class="form-control">
                                <option value="">Tất cả</option>
                                <option value="Một chiều" {{ request('loai_chuyen') == 'Một chiều' ? 'selected' : '' }}>
                                    Một chiều</option>
                                <option value="Khứ hồi" {{ request('loai_chuyen') == 'Khứ hồi' ? 'selected' : '' }}>Khứ
                                    hồi</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('bus-owner.trips.show', $trip->id) }}" class="btn btn-sm btn-info"
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger btn-delete"
                                        data-id="{{ $trip->id }}" data-name="{{ $trip->ten_xe }}" title="Xóa"
                                        data-toggle="tooltip">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                </div>
                                <form id="delete-form-{{ $trip->id }}" method="POST"
                                    action="{{ route('bus-owner.trips.destroy', $trip->id) }}" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
