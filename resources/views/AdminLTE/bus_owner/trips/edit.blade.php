...
@section('page-title', 'Chỉnh sửa chuyến xe')
@section('breadcrumb')
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-warning">
            ...
            <form action="{{ route('bus-owner.trips.update', $trip) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('ten_xe') is-invalid @enderror"
                                    ...
                                    value="{{ old('ten_xe', $trip->ten_xe) }}" required>
                                @error('ten_xe')
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('ngay_di') is-invalid @enderror"
                                    ...
                                    value="{{ old('ngay_di', $trip->ngay_di ? \Carbon\Carbon::parse($trip->ngay_di)->format('Y-m-d') : '') }}"
                                    required>
                                @error('ngay_di')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control @error('gio_di') is-invalid @enderror"
                                    ...
                                    value="{{ old('gio_di', $trip->gio_di ? \Carbon\Carbon::parse($trip->gio_di)->format('H:i') : '') }}"
                                    required>
                                @error('gio_di')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('loai_xe') is-invalid @enderror"
                                    ...
                                    <option value="Giường nằm" {{ old('loai_xe', $trip->loai_xe) == 'Giường nằm' ? 'selected' : '' }}>Giường nằm</option>
                                    <option value="Ghế ngồi" {{ old('loai_xe', $trip->loai_xe) == 'Ghế ngồi' ? 'selected' : '' }}>Ghế ngồi</option>
                                    <option value="Limousine" {{ old('loai_xe', $trip->loai_xe) == 'Limousine' ? 'selected' : '' }}>Limousine</option>
                                </select>
                                @error('loai_xe')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('loai_chuyen') is-invalid @enderror"
                                    ...
                                    <option value="Một chiều" {{ old('loai_chuyen', $trip->loai_chuyen) == 'Một chiều' ? 'selected' : '' }}>Một chiều</option>
                                    <option value="Khứ hồi" {{ old('loai_chuyen', $trip->loai_chuyen) == 'Khứ hồi' ? 'selected' : '' }}>Khứ hồi</option>
                                </select>
                                @error('loai_chuyen')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('so_cho') is-invalid @enderror"
                                    ...
                                    value="{{ old('so_cho', $trip->so_cho) }}" min="1" required>
                                @error('so_cho')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('so_ve') is-invalid @enderror"
                                    ...
                                    value="{{ old('so_ve', $trip->so_ve) }}" min="0">
                                <small class="form-text text-muted">Ghế trống: {{ $trip->so_cho - $trip->so_ve }}</small>
                                @error('so_ve')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('bus-owner.trips.show', $trip) }}" class="btn btn-secondary">
                        <i class="fas fa-times mr-2"></i>Hủy bỏ
                    </a>
                    <a href="{{ route('bus-owner.trips.index') }}" class="btn btn-info">
