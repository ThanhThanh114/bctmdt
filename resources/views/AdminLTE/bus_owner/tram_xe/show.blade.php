...
<div class="row">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('bus-owner.tram-xe.edit', $tram->ma_tram_xe) }}" class="btn btn-sm btn-warning">
                ...
                <table class="table table-hover table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-primary badge-lg">{{ $tram->ma_tram_xe }}</span>
                            </td>
                        </tr>
                        <tr>
                            <th class="bg-light">
                            ...
                            <td><strong class="text-lg">{{ $tram->ten_tram }}</strong></td>
                        </tr>
                        <tr>
                            <th class="bg-light">
                                <i class="fas fa-map-marker-alt text-danger mr-2"></i>Tỉnh/Thành phố
                            </th>
                            <td>{{ $tram->tinh_thanh ?? 'Chưa cập nhật' }}</td>
                        </tr>
                        <tr>
                            <th class="bg-light">
                                <i class="fas fa-map-pin text-info mr-2"></i>Địa chỉ chi tiết
                            </th>
                            <td>{{ $tram->dia_chi ?? $tram->dia_chi_tram ?? 'Chưa cập nhật' }}</td>
                        </tr>
                        <tr>
                            <th class="bg-light">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($tram->nhaXe->so_dien_thoai)
                                <a href="tel:{{ $tram->nhaXe->so_dien_thoai }}" class="btn btn-sm btn-outline-success">
                                    <i class="fas fa-phone-alt mr-1"></i>{{ $tram->nhaXe->so_dien_thoai }}
                                </a>
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                                @if($tram->nhaXe->email)
                                <a href="mailto:{{ $tram->nhaXe->email }}" class="btn btn-sm btn-outline-info">
                                    <i class="fas fa-envelope mr-1"></i>{{ $tram->nhaXe->email }}
                                </a>
                                @else
                                <span class="text-muted">Chưa cập nhật</span>
                                @endif
    ...
    <div class="col-md-4">
            ...
            <div class="card-body">
                <div class="info-box bg-gradient-info mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ number_format($tongChuyen) }}</span>
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <div class="info-box bg-gradient-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($tongChuyenDi) }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="info-box bg-gradient-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($tongChuyenDen) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card card-warning card-outline">
            ...
            <div class="card-body">
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-7">{{ $tram->nhaXe->ten_nha_xe }}</dd>

                    <dt class="col-sm-5">Địa chỉ:</dt>
                    <dd class="col-sm-7">{{ $tram->nhaXe->dia_chi ?? 'Chưa cập nhật' }}</dd>

                    @if($tram->nhaXe->website)
                    <dt class="col-sm-5">Website:</dt>
                    <dd class="col-sm-7">
                        <a href="{{ $tram->nhaXe->website }}" target="_blank">
                            {{ $tram->nhaXe->website }}
                        </a>
                    </dd>
                    @endif
        ...
        <div class="card card-secondary card-outline">
            ...
            <div class="card-body">
                <a href="{{ route('bus-owner.tram-xe.edit', $tram->ma_tram_xe) }}" class="btn btn-warning btn-block">
                ...
                <hr>
                <a href="{{ route('bus-owner.tram-xe.index') }}" class="btn btn-secondary btn-block">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-danger font-weight-bold">{{ $tram->ten_tram }}</p>
...
<script>
    $(document).ready(function() {
        ...
        $('#confirmDelete').click(function() {
            ...
            $.ajax({
                url: '{{ route("bus-owner.tram-xe.destroy", $tram->ma_tram_xe) }}',
                type: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
                success: function(response) {
                    if (response.success) {
                        window.location.href = '{{ route("bus-owner.tram-xe.index") }}';
                    } else {
