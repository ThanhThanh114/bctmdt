    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('bus-owner.nha-xe.edit', $nhaXe->ma_nha_xe) }}" class="btn btn-warning btn-lg">
                        <i class="fas fa-edit"></i> Chỉnh sửa
                    </a>
                    <a href="{{ route('bus-owner.nha-xe.index') }}" class="btn btn-secondary btn-lg">
    ...
    <div class="row mb-4">
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                ...
                <a href="{{ route('bus-owner.trips.index') }}" class="small-box-footer">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
                ...
                <a href="{{ route('bus-owner.tram-xe.index') }}" class="small-box-footer">
                    Xem chi tiết <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
            ...
            <div class="card shadow-sm mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('bus-owner.trips.create') }}" class="btn btn-primary btn-block mb-2">
                            <i class="fas fa-plus-circle mr-2"></i>
                            Thêm chuyến xe
                        </a>
                        <a href="{{ route('bus-owner.tram-xe.create') }}" class="btn btn-info btn-block mb-2">
                            <i class="fas fa-map-marker-alt mr-2"></i>
                            Thêm trạm xe
                        </a>
                        <a href="{{ route('bus-owner.doanh-thu.index') }}" class="btn btn-success btn-block mb-2">
