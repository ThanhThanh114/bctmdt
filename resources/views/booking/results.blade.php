                        ...
                        <div class="location-input">
                            <select name="start" required>
                                ...
                                @foreach($cities as $city)
                                    <option value="{{ $city->ten_tram }}" {{ ($start ?? '') == $city->ten_tram ? 'selected' : '' }}>
                                        {{ $city->ten_tram }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="location-field">
                        ...
                        <div class="location-input">
                            <select name="end" required>
                                ...
                                @foreach($cities as $city)
                                    <option value="{{ $city->ten_tram }}" {{ ($end ?? '') == $city->ten_tram ? 'selected' : '' }}>
                                        {{ $city->ten_tram }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange">
                                ...
                                <div style="display: flex; align-items: center; justify-content: space-between;">
                                    <div style="text-align: center;">
                                        <div style="font-size: 24px; font-weight: bold; color: var(--primary-color, #FF7B39);">
                                            {{ date('H:i', strtotime($selectedTrip->gio_di)) }}
                                        </div>
                                        <div style="font-size: 14px; color: #666; margin-top: 4px;">{{ $selectedTrip->tramDi->ten_tram }}</div>
                                    </div>
                                    ...
                                    <div style="flex: 1; margin: 0 20px; position: relative;">
                                        ...
                                        <div style="text-align: center; font-size: 12px; color: #666; margin-top: 4px;">
                                            {{ \Carbon\Carbon::parse($selectedTrip->ngay_di)->format('d/m/Y') }}
                                        </div>
                                    </div>

                                    <div style="text-align: center;">
                                        <div style="font-size: 24px; font-weight: bold; color: var(--primary-color, #FF7B39);">19:30</div>
                                        <div style="font-size: 14px; color: #666; margin-top: 4px;">{{ $selectedTrip->tramDen->ten_tram }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="trip-details-info">
                                <div class="info-row">
                                    ...
                                    <span style="font-weight: 600;">{{ $selectedTrip->nhaXe->ten_nha_xe }}</span>
                                </div>
                                <div class="info-row">
                                    <span style="color: #666; font-weight: 500;">
                                        <i class="fas fa-bus" style="color: var(--primary-color, #FF7B39); margin-right: 8px;"></i>Loại xe:
                                    </span>
                                    <span style="font-weight: 600;">{{ $selectedTrip->loai_xe }}</span>
                                </div>
                                <div class="info-row">
                                    <span style="color: #666; font-weight: 500;">
                                    ...
                                    <span style="font-weight: 700; font-size: 20px; color: var(--primary-color, #FF7B39);">
                                        {{ number_format($selectedTrip->gia_ve, 0, ',', '.') }}đ
                                    </span>
                                </div>
                                <div class="info-row">
                                    <span style="color: #666; font-weight: 500;">
                                    ...
                                    <span style="font-weight: 600; color: #28a745;">
                                        {{ $selectedTrip->available_seats }} chỗ
                                    </span>
                                </div>
                            </div>
                        </div>
