                    ...
                    <div class="col-md-9">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>{{ $user->date_of_birth ? \Carbon\Carbon::parse($user->date_of_birth)->format('d/m/Y') : 'Chưa cập nhật' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $user->created_at ? \Carbon\Carbon::parse($user->created_at)->format('d/m/Y H:i') : 'Chưa cập nhật' }}</td>
                            </tr>
                            <tr>
                                <td><strong>Lần đăng nhập cuối:</strong></td>
                                <td>{{ $user->updated_at ? \Carbon\Carbon::parse($user->updated_at)->format('d/m/Y H:i') : 'Chưa cập nhật' }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="info-box bg-primary">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $user->datVe()->count() }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $user->datVe()->whereStatus('confirmed')->count() }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($user->datVe()->whereStatus('confirmed')->get()->sum(function($booking) { return $booking->chuyenXe->gia_ve ?? 0; })) }}đ</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-6">
                        <div class="info-box bg-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ App\Models\DatVe::whereStatus('pending')->count() }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    @if(strtolower($user->role) === 'bus_owner')
                    <div class="col-md-6">
                        <div class="info-box bg-info">
                            <span class="info-box-icon"><i class="fas fa-bus"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text">Chuyến xe</span>
                                <span class="info-box-number">{{ $user->nhaXe ? $user->nhaXe->chuyenXe()->count() : 0 }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('password.edit') }}" class="btn btn-info btn-block">
